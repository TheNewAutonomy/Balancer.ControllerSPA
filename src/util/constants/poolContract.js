      ...
      inputs: [
        ...
        },
        {
          ...
          components: [
            ...
            { type: "uint256[]", name: "normalizedWeights" },
            { type: "uint256", name: "swapFeePercentage" },
            { type: "bool", name: "swapEnabledOnStart" },
            { type: "bool", name: "mustAllowlistLPs" },
            { type: "uint256", name: "managementAumFeePercentage" },
            { type: "uint256", name: "aumFeeId" }
          ]
        },
